...
$(window).ready(function () {
  $(".se-pre-con").delay(300).fadeOut("fade");
});
...
jQuery(document).ready(function ($) {
  ...
  minimized_elements.each(function () {
    ...
    $(this).html(
      t.slice(0, 150) +
        '<span>... </span><a href="#" style="display:none;" class="more">More</a>' +
        '<span style="display:none;">' +
        t.slice(130, t.length) +
        ' <a href="#" style="display:none;" class="less">Less</a></span>'
    );
  });
